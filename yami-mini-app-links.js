(() => {
  ...
  const syncDashboardCards = () => {
    if (!document.getElementById('yami-dashboard-sync-style')) {
      ...
      style.textContent = `
        ion-card.yami-sync-card{--background:#fff!important;margin:18px 16px 0!important;border-radius:20px!important;background:linear-gradient(145deg,#fff,#f8fafc)!important;box-shadow:0 8px 22px rgba(5,31,48,.16)!important;overflow:hidden!important}ion-card.yami-sync-card ion-card-header,ion-card.yami-sync-card ion-card-content{background:transparent!important}ion-card.yami-sync-card ion-card-header{padding:18px 18px 6px!important}ion-card.yami-sync-card ion-card-subtitle,.yami-quick-title{color:#1b3040!important;font:800 18px -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif!important;text-transform:none!important;letter-spacing:0!important}.yami-quick-title{padding:18px 18px 6px}.top-card-content.yami-sync-card{min-height:0!important;padding:0 10px 13px!important}.top-card-content.yami-sync-card ion-grid{padding:0!important}.top-card-content.yami-sync-card ion-col{padding:7px 2px!important}.top-card-content.yami-sync-card ion-label{min-height:24px!important}ion-card.yami-sync-card ion-card-content{padding:6px 10px 13px!important}ion-card.yami-sync-card ion-grid{padding:5px 2px!important}ion-card.yami-sync-card ion-col{padding:7px 2px!important}ion-card.yami-sync-card button{width:100%;min-width:0!important;padding:2px 0!important;background:transparent!important;color:#1c2d37!important;box-shadow:none!important;text-transform:none!important}ion-card.yami-sync-card ion-icon{width:31px!important;height:31px!important;margin:0 auto 6px!important;color:#000!important;filter:brightness(0) saturate(100%)}ion-card.yami-sync-card ion-label{display:block!important;min-height:27px!important;white-space:normal!important;color:#263641!important;font:600 11px/1.15 -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif!important}.card-wrapper.yami-sync-card{padding:5px 0!important}.card-wrapper.yami-sync-card .account-balance{--background:transparent!important;--padding-start:14px!important;--inner-padding-end:14px!important;background:transparent!important}.card-wrapper.yami-sync-card .balance-grid{display:grid!important;grid-template-columns:58px minmax(0,1fr) auto!important;align-items:center!important;width:100%!important}.card-wrapper.yami-sync-card .grid-col h5{margin:0!important;color:#1b3040!important;font:800 18px -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif!important}.card-wrapper.yami-sync-card .grid-col.last{display:block!important;visibility:visible!important;white-space:nowrap!important;color:#1b3040!important;font:700 18px -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif!important;text-align:right!important}.yami-logo-mark{display:flex;flex-direction:column;align-items:center;justify-content:center;width:54px;height:54px;color:#ff671d;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;font-weight:900;line-height:1}.yami-logo-mark span{display:grid;place-items:center;width:42px;height:42px;border-radius:13px;background:#ff671d;color:#fff;font-size:23px;font-style:italic}.yami-logo-mark small{margin-top:2px;font-size:9px;font-weight:900;letter-spacing:.35px}.adverts-wrapper.yami-sync-card{display:none!important}
      `;
      document.head.appendChild(style);
    }
    ...
    if (quickActions && !quickActions.querySelector('.yami-quick-title')) quickActions.insertAdjacentHTML('afterbegin', '<div class="yami-quick-title">Quick actions</div>');
  };
