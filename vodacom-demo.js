(() => {
  ...
  const open = () => {
    ...
    const flows = {
      ...
      send: { title: 'Send money', copy: 'Enter the recipient you want to pay from your Yami main balance.', input: 'Recipient mobile number', value: () => '072 555 0198', choices: [['R20', 20], ['R50', 50], ['R100', 100]] },
      ...
      transfer: { title: 'Transfer airtime', copy: 'Share airtime with another prepaid number.', input: 'Recipient mobile number', value: () => '072 555 0198', choices: [['R10', 10], ['R20', 20], ['R40', 40]] },
      ...
      fibre: { title: 'Get Fibre', copy: 'Choose a monthly Fibre plan. This demo will request your Yami balance payment.', input: 'Installation address', value: () => '12 Vilakazi Street, Soweto', choices: [['20Mbps · R199', 199], ['50Mbps · R349', 349], ['100Mbps · R499', 499]] },
